...
# It is one of the exciting beginner Python
# projects with source code. Every time a user
# runs the code, the random story generator
# project tries to produce a different and random
# story.
